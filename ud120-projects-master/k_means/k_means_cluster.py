...
def minmaxscalerFunctoin():
    import pickle
    from sklearn.preprocessing import MinMaxScaler
    import numpy

    data_dict = pickle.load(open(
        "../final_project/final_project_dataset.pkl", "r"))
    ### there's an outlier--remove it!
    data_dict.pop("TOTAL", 0)

    # Apply feature scaling to your k-means clustering code from the last lesson,
    # use only two feature salary and excercised_stock_options
    ...
    ex_stok = [3285, 1000000.0, max(ex_stok)]
    ...
    return rescaled_salary,rescaled_stock
print 'the rescalling on the salary and exercised_Stock_option is =/n'
print minmaxscalerFunctoin()